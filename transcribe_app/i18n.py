...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dlg.settings.general":     "General",
        "dlg.settings.recording":   "Recording",
        "dlg.settings.recognition": "Recognition",
        "dlg.settings.general_hint": "Language and interface defaults",
        "dlg.settings.recording_hint": "Recording persistence and post-processing",
        "dlg.settings.recognition_hint": "Model, engine, and silence behavior",
    ...
    "de": {
        ...
        "dlg.settings.general":     "Allgemein",
        "dlg.settings.recording":   "Aufnahme",
        "dlg.settings.recognition": "Erkennung",
        "dlg.settings.general_hint": "Sprache und Oberfläche",
        "dlg.settings.recording_hint": "Aufnahme-Speicherung und Nachbearbeitung",
        "dlg.settings.recognition_hint": "Modell, Engine und Stille-Verhalten",
