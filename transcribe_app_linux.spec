...
# PyInstaller spec for Linux (x86_64)
# Build on Linux with:
...
# Collect all files (Python, data, shared libs) from heavy packages
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=False,   # no terminal window; set True to see startup errors
